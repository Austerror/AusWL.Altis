...
savePlayerHandle = _this spawn
{
	   ...
	   {!isNil "respawnDialogActive" && {!respawnDialogActive}}) then
	{
		...
		[_data, ["IsAlive", player getVariable ["isAlive", 0]]] call BIS_fnc_arrayPush;
		...
		[_data, ["Exp", player getVariable ["experience", 0]]] call BIS_fnc_arrayPush;
		[_data, ["Lvl", player getVariable ["level", 0]]] call BIS_fnc_arrayPush;
