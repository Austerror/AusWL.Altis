...
//getServerTime = [_customFunc, "realTimeSync.sqf"] call mf_compile;
...
FNC_instring = [_clientFunc, "instring.sqf"] call mf_compile;
FNC_instring2 = [_clientFunc, "instring2.sqf"] call mf_compile;
