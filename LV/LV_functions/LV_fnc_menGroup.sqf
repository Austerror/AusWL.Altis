...
// _OPFmen removes "O_Soldier_GL_F","O_soldier_AA_F","O_soldier_AT_F","O_soldier_AAR_F","O_soldier_AAA_F","O_soldier_AAT_F"
// _OPFmen2 removes "O_soldier_AAR_F","O_soldier_AAA_F","O_soldier_AAT_F"
// _INDmen removes "I_soldier_AA_F","I_soldier_AT_F","I_Soldier_GL_F","I_soldier_AAR_F","I_soldier_AAA_F","I_soldier_AAT_F"
...
_OPFmen = ["O_Soldier_A_F","O_soldier_AR_F","O_medic_F","O_engineer_F","O_soldier_exp_F","O_soldier_M_F","O_officer_F","O_soldier_repair_F","O_Soldier_F","O_soldier_LAT_F","O_Soldier_lite_F","O_Soldier_SL_F","O_Soldier_TL_F"];
_OPFmen2 = ["O_recon_exp_F","O_recon_JTAC_F","O_recon_M_F","O_recon_medic_F","O_recon_F","O_recon_LAT_F","O_recon_TL_F"];
_OPFarrays = [_OPFmen,_OPFmen2];
_INDmen = ["I_Soldier_A_F","I_soldier_AR_F","I_medic_F","I_engineer_F","I_soldier_exp_F","I_soldier_M_F","I_officer_F","I_soldier_repair_F","I_Soldier_F","I_soldier_LAT_F","I_Soldier_lite_F","I_Soldier_SL_F","I_Soldier_TL_F"];
