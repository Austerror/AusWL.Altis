...
while {true} do
{
    ...
    _str = format["%1<br/>%2 <img size='0.7' image='client\icons\exp.paa'/>", _str, player getVariable "experience"];
    _str = format["%1<br/>%2 <img size='0.7' image='client\icons\lvl.paa'/>", _str, player getVariable "level"];
