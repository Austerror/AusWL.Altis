...
_error = [_vehicle] call mf_can_paintvehicleblue;
...
if (_success) then {
	player removeMagazine "sc_spraypaintblue";
	[_vehicle, "#(argb,8,8,3)color(0,0.2,1,0.75)"] call applyVehicleTexture;
	_vehicle setVariable ["vehicleTexture", "#(argb,8,8,3)color(0,0.2,1,0.75)", true];
