...
_error = [_vehicle] call mf_can_paintvehiclegrey;
...
if (_success) then {
	player removeMagazine "sc_spraypaintgrey";
	[_vehicle, "#(argb,8,8,3)color(0.5,0.51,0.512,0.3)"] call applyVehicleTexture;
	_vehicle setVariable ["vehicleTexture", "#(argb,8,8,3)color(0.5,0.51,0.512,0.3)", true];
