...
_error = [_vehicle] call mf_can_paintvehicleblack;
...
if (_success) then {
	player removeMagazine "sc_spraypaintblack";
	[_vehicle, "#(argb,8,8,3)color(0.1,0.1,0.1,0.1)"] call applyVehicleTexture;
	_vehicle setVariable ["vehicleTexture", "#(argb,8,8,3)color(0.1,0.1,0.1,0.1)", true];
