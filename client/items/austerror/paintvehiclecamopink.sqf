...
_error = [_vehicle] call mf_can_paintvehiclecamopink;
...
if (_success) then {
	player removeMagazine "sc_spraypaintcamopink";
	[_vehicle, "client\images\vehicleTextures\camo_pank.jpg"] call applyVehicleTexture;
	_vehicle setVariable ["vehicleTexture", "client\images\vehicleTextures\camo_pank.jpg", true];
