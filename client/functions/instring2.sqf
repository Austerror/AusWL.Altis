...
//diag_log format ["Instring: _needle = %1", _needle];
_haystackRAW = _this select 1;
_haystack = toArray (format ["%1",_haystackRAW]);

//diag_log format ["Instring: _haystack = %1", _haystack];
_needleLen = count toArray _needle;
_hay = +_haystack;
//diag_log format ["Instring: toString(_haystack) = %1", tostring(_haystack)];
