...
[1.0, 1.0, 2.0, 0.25, 0],	// civil (commercial)
[1.75, 2.0, 1.5, 0.75, 0],	// military
[0.5, 1.0, 3.0, 0.25, 0],	// industrial (major)
[1.0, 1.5, 3.0, 0.25, 0],	// research (medical)
[0.5, 0.5, 1.5, 0.25, 0],	// residential
[0.25, 0.25, 0.5, 0.25, 0]	// industrial (minor)
];
